...
class InterfaceBulkCreateForm(
    form_from_model(Interface, ['type', 'enabled', 'poe_enabled', 'mtu', 'mgmt_only', 'mark_connected']),
    DeviceBulkAddComponentForm
):
    model = Interface
    field_order = (
        'name_pattern', 'label_pattern', 'type', 'enabled', 'poe_enabled', 'mtu', 'mgmt_only', 'mark_connected', 'description', 'tags',
    )
